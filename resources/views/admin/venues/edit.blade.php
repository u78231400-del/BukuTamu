...
@section('subtitle', 'Perbarui informasi venue')
        ...
        <div class="admin-card p-4 mb-4">
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi"
                          class="form-control"
                          rows="3"
                          placeholder="Jelaskan tentang venue ini">{{ old('deskripsi', $venue->deskripsi) }}</textarea>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="status" class="form-select" required>
                        ...
                        <option value="available" {{ old('status', $venue->status) === 'available' ? 'selected' : '' }}>
                            Tersedia
                        </option>
                        <option value="unavailable" {{ old('status', $venue->status) === 'unavailable' ? 'selected' : '' }}>
                            Tidak Tersedia
                        </option>
                    </select>
                </div>
                ...
                <div class="file-upload" id="file-upload">
                    ...
                    @if($venue->foto)
                        <div class="current-photo" id="current-photo">
                            ...
                            <img src="{{ asset('storage/' . $venue->foto) }}" alt="Foto Venue">
                        </div>
                    @endif
                </div>
            </div>
