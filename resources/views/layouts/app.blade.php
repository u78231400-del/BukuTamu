...
<head>
    ...
    <title>@yield('title', 'RS Medika')</title>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <div class="nav-item">
                    <a href="/" class="nav-link {{ request()->is('/') || request()->is('bukutamu') ? 'active' : '' }}">
                        <i class="fas fa-hospital-user"></i>
                        <span>Kunjungan Pasien</span>
                    </a>
                </div>
                <div class="nav-item">
                    <a href="/buat-janji" class="nav-link {{ request()->is('buat-janji') ? 'active' : '' }}">
            ...
            <div class="header-right">
                ...
                <div class="notif-dropdown" id="notifDropdown">
                    <div class="notif-header">
                        ...
                        @if($pendingCount > 0)
                        <span class="notif-count">{{ $pendingCount }} baru</span>
                        @endif
                    </div>
                    <div class="notif-body">
                        ...
                        <a href="/bukutamu?status=menunggu" class="notif-item">
                            ...
                            <div class="notif-content">
                                <div class="notif-text">{{ $pendingCount }} janji menunggu persetujuan</div>
                ...
                <div class="profile-section" onclick="toggleProfileDropdown(this)">
                    <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=4f46e5&color=fff&size=64&font-size=0.35" alt="Profile" class="profile-img">
