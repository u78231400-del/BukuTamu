...
@section('title', 'Tambah Jadwal Venue')
@section('subtitle', 'Tambahkan jadwal booking offline, acara internal, atau blokir venue.')
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="jenis"
                            ...
                            <option value="offline" {{ old('jenis') == 'offline' ? 'selected' : '' }}>
                                Booking Offline
                            </option>
                            <option value="internal" {{ old('jenis') == 'internal' ? 'selected' : '' }}>
                                Acara Internal
                            </option>
                            <option value="blocked" {{ old('jenis') == 'blocked' ? 'selected' : '' }}>
                                Venue Diblokir
                            </option>
                        </select>
                        @error('jenis')
