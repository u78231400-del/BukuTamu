...
<body>
        ...
        <div class="row g-3">
            <div class="col-lg-3">
                <div class="bg-white p-3 rounded-3 shadow-sm">
                    <div class="date-nav mb-2">
                        ...
                        <span class="date-display" id="monthYearDisplay"><?php echo e($currentMonthName); ?> <?php echo e($currentYear); ?></span>
                    ...
                    <div class="d-flex gap-2 mb-2">
                        ...
                        <button class="btn btn-sm btn-primary flex-fill" onclick="goToDate('<?php echo e($today); ?>')">Sekarang</button>
                    </div>
                    ...
                    <div class="calendar-mini" id="calendarMini">
                        ...
                        <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                            ...
                            ?>
                            <div class="<?php echo e($classes); ?>" onclick="goToDate('<?php echo e($date); ?>')"><?php echo e($day); ?></div>
                        <?php endfor; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-9">
                <div class="bg-white p-4 rounded-3 shadow-sm">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="date-nav">
                            ...
                            <span class="date-display" id="dateDisplay"><?php echo e($selectedDateFormatted); ?></span>
                            <button class="btn-nav" onclick="changeDate(1)">&rarr;</button>
                        </div>
                        <div class="text-muted">
                            <strong><?php echo e($appointments->total()); ?></strong> janji pada hari ini
                        </div>
                    </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="time-slot has-appointment <?php echo e($isPast ? 'completed' : ''); ?>">
                                        ...
                                        <div class="guest-info">
                                            <i class="fas fa-phone"></i> <?php echo e($apt->nomor_hp); ?><br>
                                            <i class="fas fa-bullseye"></i> <?php echo e($apt->tujuan); ?><br>
                                            <i class="fas fa-users"></i> <?php echo e($apt->jumlah_orang); ?> orang
                                        </div>
                                        <?php if($apt->pesan): ?>
                                            <div class="mt-2 p-2 bg-light rounded" style="font-size: 12px; color: #666;">
                                                <i class="fas fa-comment"></i> <?php echo e(Str::limit($apt->pesan, 80)); ?>
                ...
                <div class="d-flex justify-content-center mt-3">
                    <?php echo e($appointments->appends(['date' => $selectedDate])->links()); ?>

                </div>
                <?php endif; ?>

                <?php if($historyByMonth->isNotEmpty()): ?>
                <div class="history-section">
                    <hr>
                    <h5 class="mb-3"><i class="fas fa-history"></i> Riwayat Janji Terlaksana</h5>
                    <?php $__currentLoopData = $historyByMonth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monthName => $appointments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="history-month">
                            <div class="history-month-title"><?php echo e($monthName); ?></div>
                            <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="history-item">
                                    <div>
                                        <div class="history-date">
                                            <i class="far fa-calendar"></i>
                                            <?php echo e(\Carbon\Carbon::parse($apt->tanggal_janji)->translatedFormat('l, d F Y')); ?>

                                        </div>
                                        <div class="history-info">
                                            <i class="far fa-clock"></i> <?php echo e(\Carbon\Carbon::parse($apt->jam_janji)->format('H:i')); ?> |
                                            <i class="far fa-user"></i> <?php echo e($apt->nama); ?> |
                                            <i class="fas fa-bullseye"></i> <?php echo e($apt->tujuan); ?>
    ...
    <script>
        ...
        let selectedDate = '<?php echo e($selectedDate); ?>';
